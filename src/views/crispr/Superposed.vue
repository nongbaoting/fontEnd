...
<script>
import nglView from './AlignScore/molstar_superpose_data.vue'
  ...
  methods: {
    getOneInfo() {
      this.$http({
        ...
        params: {
          dataType: 'info',
          input_pdb: 'ranked_0.pdb',
          db_pdb: '8045558.A5HC98.5AMR.A.197-1745.pdb',
          uuid: 'ef226467-a057-4c96-a062-4b819f1fe5d2',
        },
      }).then((response) => {
